...
# Definir colores
COLOR_1 = "#215895"  # Naranja
COLOR_2 = '#056d80'  # Azul oscuro
COLOR_3 = '#00c8c0'  # Azul brillante
COLOR_4 = '#f9b62d'  # Azul claro
COLOR_5 = '#5b5b5b'
COLOR_6 = '#141414'
...
st.markdown(
    ...
    .stApp {{
        background-color: #FFFFF;  /* Fondo blanco para mejor legibilidad */
    }}
    ...
    span[data-baseweb="tag"] {{
        background-color: {COLOR_3};   /* Fondo */
        color: white;             /* Texto */
        }}
    
    button[data-testid="stBaseButton-secondary"] {{
        background-color: {COLOR_2};   /* Fondo */
        color: white;             /* Texto */
        }}
        
    button[data-testid="stBaseButton-secondary"]:hover {{
        background-color: {COLOR_3}; /* Fondo al pasar el mouse */
    ...
    .st-emotion-cache-1ksltpv {{
        background-color: {COLOR_1};   /* Fondo */
        color: white;             /* Texto */
        }}
    ...
    span[class="st-emotion-cache-ycmcfb eamlidg3"] {{
        color: white;             /* Texto */
        }}
        
    span[class="st-emotion-cache-ycmcfb e1d2qte93"] {{
        color: white;             /* Texto */
        }}
    ...
    div[role="slider"] {{
        background-color: {COLOR_1};             /* Texto */
        }}

    .st-e4 {{
        background: linear-gradient(to right, {COLOR_1} 0%, {COLOR_1} 14.6341%, rgba(151, 166, 195, 0.25) 14.6341%, rgba(151, 166, 195, 0.25) 100%)
    }}
